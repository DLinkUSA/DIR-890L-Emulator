...
{	
	if (localStorage.getItem('language') == "ru-ru")	{	document.getElementById(menuId).style.background = "url(./image/navigation_bg6.gif?v=20141117210117) right top no-repeat";	}
	else	{	document.getElementById(menuId).style.background = "url(./image/navigation_bg5.gif?v=20141117210117) right top no-repeat";	}
}
