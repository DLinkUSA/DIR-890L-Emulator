...
{	
    ...
    get VPNLocalIPAddress(){
	    if(this._VPNLocalIPAddress == "0.0.0.0")
		        return "";

		return this._VPNLocalIPAddress;
	},
	
	set VPNLocalIPAddress(val){
		this._VPNLocalIPAddress = val;
	},
	
	get VPNLocalSubnetMask(){
		if(this._VPNLocalSubnetMask == "0.0.0.0")
			return "";
		
		return this._VPNLocalSubnetMask;
	},
	
	set VPNLocalSubnetMask(val){
		this._VPNLocalSubnetMask = val;
	},
	
	get VPNLocalGateway(){
	    if(this._VPNLocalGateway == "0.0.0.0")
		        return "";

	    return this._VPNLocalGateway;
	},
	
	set VPNLocalGateway(val){
		this._VPNLocalGateway = val;
	}
