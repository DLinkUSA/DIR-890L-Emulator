/* include menu.js */
document.write('<script type="text/javascript" charset="utf-8" src="resources/menu.js' + ini_ver + '"></script>');
/* include DetectRouterConnection.js */
document.write('<script type="text/javascript" charset="utf-8" src="resources/DetectRouterConnection.js' + ini_ver + '"></script>');
